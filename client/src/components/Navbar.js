...
function NavBar ({setLat, setLng, currentUser, setCurrentUser, placeId, setPlaceId, storedLocations, setStoredLocations, setCurrentLocationInfo, autoCompleteAddress, setAutoCompleteAddress}) {
    ...
    return (
        <div className='nav-container'>  
            ...
            <SearchBar placeholder='search by zipcode' setLat={setLat} setLng={setLng} placeId={placeId} setPlaceId={setPlaceId} storedLocations={storedLocations} setStoredLocations={setStoredLocations} setCurrentLocationInfo={setCurrentLocationInfo} autoCompleteAddress={autoCompleteAddress} setAutocompleteAddress={setAutoCompleteAddress} />
            {currentUser ? 
