    ...
    return(
        ...
        <div className='feed-container'>
            <div className='feed-header'>
                <CurrentUserAccountBanner currentUser={currentUser} userInfo={currentUser} numOfPosts={numOfPosts} diffInDate={diffInDate} lastPostedFrom={lastPostedFrom} lastPostedFromName={lastPostedFromName} setPlaceId={setPlaceId} setAutoCompleteAddress={setAutoCompleteAddress} />
            </div>
